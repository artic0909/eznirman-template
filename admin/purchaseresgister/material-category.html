...
<head>
    <title>All Material Categories</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="../../assets/images/logo.gif" type="image/x-icon"> <!-- [Google Font] Family -->
    <link rel="stylesheet"
...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link"><span class="pc-micon"><i
                                    class="ti ti-building-skyscraper"></i></span><span class="pc-mtext">Working
                                Sites</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                    ...
                    <li class="pc-item pc-hasmenu pc-trigger">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item active"><a class="pc-link" href="#!">Material Category</a></li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link"><span class="pc-micon"><i
                                    class="ti ti-currency-rupee"></i></span><span class="pc-mtext">Petty
                                Cash</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            ...
                            <div class="dropdown-header">
                                <div class="d-flex mb-1">
                                    <div class="flex-shrink-0">
                                        <img src="../../assets/images/logo.gif" alt="user-image"
                            ...
                            <ul class="nav drp-tabs nav-fill nav-tabs" id="mydrpTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="drp-t2" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false"><i class="ti ti-phone"></i>
                                        Help?</button>
                                </li>
                            </ul>
        ...
        <div class="pc-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-10">
                            <div class="page-header-title">
                                <h5 class="m-b-10">All Material Category</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript: void(0)">Purchase Resgister</a></li>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">All Material Categories</h5>
                            <div class="d-flex gap-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="bulkActionDropdown">
                                        ...
                                        <li>
                                            <a class="dropdown-item text-success" href="#" id="bulkActive">
                                                <i class="ti ti-check me-2"></i>Active Selected
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item text-warning" href="#" id="bulkInactive">
                ...
                <div class="modal-dialog modal-lg">
                    <form class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addUnitModalLabel">Add Material Category</h5>
            ...
            <div class="modal fade" id="editUnitModal" tabindex="-1" aria-labelledby="editUnitModalLabel"
                ...
                <div class="modal-dialog modal-lg">
                    <form class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editUnitModalLabel">Edit Material Category</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="" class="form-label">Category Name<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="" value="CL061">
                                </div>
            ...
            <div class="modal fade" id="deleteUnitModal" tabindex="-1" aria-labelledby="deleteUnitModalLabel"
                ...
                <div class="modal-dialog">
                    <form class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="deleteUnitModalLabel">Delete Material Category</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Are you sure you want to delete this material category?</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <script>
        ...
        document.getElementById('bulkActivate').addEventListener('click', function (e) {
            ...
            if (selectedIds.length > 0) {
                console.log('Activating IDs:', selectedIds);
                alert(`Activating ${selectedIds.length} selected item(s)`);
        ...
        document.getElementById('bulkDeactivate').addEventListener('click', function (e) {
            ...
            if (selectedIds.length > 0) {
                console.log('Deactivating IDs:', selectedIds);
                alert(`Deactivating ${selectedIds.length} selected item(s)`);
